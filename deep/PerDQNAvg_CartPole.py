...
from Per_MyCartPole import MyCartPoleEnv as Per_MyCartPoleEnv
from MyCartPole import MyCartPoleEnv as Ori_MyCartPoleEnv
from tqdm import tqdm

parser = argparse.ArgumentParser()
parser.add_argument("--lr", default=1e-3, type=float)
parser.add_argument("--lr_embedding", default=1e-3, type=float)
...
save_dir_name = 'plot-PerDQNAvg-CartPole'
global_log_dir = './PerDQNAvg-CartPole/'
...
def integrate_personalization(
    ...
    env_class = Per_MyCartPoleEnv
    ori_env_class = Ori_MyCartPoleEnv
...
def integrate_diff_merge_interval():
    ...
    gamma = GAMMA
    lr = LR
    train_episodes_upper_bound = 768
