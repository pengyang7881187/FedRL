...
from MyHopper import MyHopperEnv
...
log_dir = './DDPGAvg-Hopper/'
save_dir = 'plot-DDPGAvg-Hopper'
outer_loop_num = 10
...
def integrate_diff_merge_interval():
    ...
    env_class = MyHopperEnv
    gamma = 0.99
    total_frame_upper_bound = int(3200000)
    ...
    merge_interval_set = [10000, 40000]
...
def report_diff_merge_interval(env_class: Type[MyEnv],
    ...
    for count in tqdm(range(outer_loop_num)):
        ...
        # Compute baseline-Max and baseline-Avg and DDPG-Avg with E=Inf
